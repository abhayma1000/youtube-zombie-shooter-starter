...
class ZombieNet(nn.Module):
    def __init__(self, action_dim, hidden_dim=1024, dropout=0, observation_shape=None):
        ...
        print("Conv output side: ", conv_output_size)
    ...
    def save_the_model(self, filename=os.path.join("models", "latest.pth")):
        torch.save(self.state_dict(), filename)
    
    def load_the_model(self, filename=os.path.join("models", "latest.pth")):
        try:
