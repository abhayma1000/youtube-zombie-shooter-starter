...
world_height=WORLD_HEIGHT, world_width=WORLD_WIDTH, fps=FPS, sound=False, render_mode='human')

observation, info = env.reset()

agent = Agent(env, dropout=dropout, hidden_layer=hidden_layer,
learning_rate=learning_rate, step_repeat=step_repeat, gamma=gamma)
...
model1.load_the_model(os.path.join("models", "dqn1.pth"))
model2.load_the_model(os.path.join("models", "dqn2.pth"))
